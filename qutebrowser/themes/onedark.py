...
c.colors.completion.fg = ['#abb2bf', 'white', 'white']
...
c.colors.completion.item.selected.bg = '#839496'
...
c.colors.completion.scrollbar.bg = fg_default
# -------------------------------------------
